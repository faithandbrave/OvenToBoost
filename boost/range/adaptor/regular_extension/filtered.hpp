#ifndef BOOST_RANGE_ADAPTOR_REGULAR_EXTENSION_FILTERED_INCLUDE
#define BOOST_RANGE_ADAPTOR_REGULAR_EXTENSION_FILTERED_INCLUDE
...
#endif // BOOST_RANGE_ADAPTOR_REGULAR_EXTENSION_FILTERED_INCLUDE
