...
void test()
{
    // operator style
    {
        ...
        BOOST_TEST(boost::equal(c | boost::adaptors::taken_while(is_less4), expected));
    }
    {
    ...
    }
    {
        ...
        Container c = boost::assign::list_of(3)(1)(4)(2)(5);
        c |+ boost::adaptors::taken_while(_1 % 2 != 0)
          |  boost::range::access::front = 0;

        const Container expected = boost::assign::list_of(0)(1)(4)(2)(5);
    ...
    // function style
    {
        const Container c = boost::assign::list_of(3)(1)(4)(2)(5);
        const Container expected = boost::assign::list_of(3)(1);
        BOOST_TEST(boost::equal(boost::adaptors::take_while(c, is_less4), expected));
    }
    {
        Container c = boost::assign::list_of(3)(1)(4)(2)(5);
        const Container expected = boost::assign::list_of(3)(1);
    ...
    }
    {
        ...
        boost::range::access::front(
            boost::adaptors::take_while(c, boost::regular(_1 % 2 != 0))
        ) = 0;
